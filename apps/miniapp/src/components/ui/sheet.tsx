...
const sheetVariants = cva(
  'rounded-t-2xl fixed z-50 gap-4 bg-background p-4 pb-12 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out',
  {
    variants: {
      side: {
...
>(({className, ...props}, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn(
      'text-lg text-center font-semibold text-foreground',
      className,
    )}
    {...props}
  />
